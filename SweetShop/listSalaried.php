...
if(isset($_REQUEST['submit']))
{
  ...
  {
    //echo $arr[$i];
    $q="select Salary as total from SALARIED_EMP where E_ID=".$arr[$i].";";  
    //echo $arr[$i];
...
$i="select FirstName,LastName,EMPLOYEE.E_ID from EMPLOYEE,SALARIED_EMP where EMPLOYEE.E_ID=SALARIED_EMP.E_ID;";
$r=mysql_query($i,$connect);
//$t=mysql_fetch_assoc($r);
//print_r($t);
echo "<form action='listSalaried.php'>";
